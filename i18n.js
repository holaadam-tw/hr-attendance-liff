(function () {
    ...
    var DICT = {
        'zh-TW': {
            ...
            leaveAM: '上午半天',
            leavePM: '下午半天',
            leaveFullDayOption: '全日（1 天）',
            leaveAMOption: '上午半天（0.5 天）',
            leavePMOption: '下午半天（0.5 天）',
            leavePeriodHint: '半天與時數假只能選同一天；時數假至少 1 小時並依實際起訖時間自動計算。',
            leaveDeductDays: '扣薪天數',
            dayUnit: '天',
            hourUnit: '小時',
            leaveStatusPending: '⏳ 待審',
            leaveStatusApproved: '✅ 通過',
            leaveStatusRejected: '❌ 拒絕',
            hourlyLeave: '小時請假',
            leaveHours: '時數假起訖時間',
            leaveHoursHint: '系統依開始與結束時間自動計算時數，並以每 8 小時折算 1 天。',
            leaveReason: '原因',
            submitRequest: '📤 提交申請',
            ...
            overtimeDesc: '加班需事前或事後申請，審核通過後依核准時數計算',
            overtimeDate: '加班日期',
            plannedOvertimeHours: '預計加班時數',
            overtimeRateHint: '💡 前 2h：時薪 ×1.34 · 後 2h：時薪 ×1.67',
            overtimeCompensation: '加班補償方式',
            overtimePay: '領加班費',
            compLeave: '換補休',
            overtimeReason: '加班原因',
            overtimeReasonPlaceholder: '例：趕出貨、客戶會議',
            submitOvertime: '📤 提交加班申請',
            overtimeHistory: '加班記錄',
            noOvertimeHistory: '尚無加班記錄',
            overtimeMissingFields: '請填寫日期與時數',
            overtimeMaxHours: '加班時數不可超過 12 小時',
            overtimeSubmitSuccess: '加班申請已提交',
            overtimeSubmitReview: '申請已提交，等待審核',
            overtimeSubmitFailed: '申請失敗',
            overtimePayLabel: '加班費',
            compLeaveLabel: '補休',
            overtimeFinalPay: '計薪',
            overtimeApprovedHours: '核准',
            overtimeActualHours: '實際',
            loadFailed: '載入失敗',
            loginFirst: '請先登入',
            lunchOrder: '便當訂購',
        ...
        'vi-VN': {
            ...
            leaveAnnualFull: 'Nghỉ phép năm',
            leaveAnnualShort: 'Phép năm',
            leaveSick: 'Nghỉ bệnh',
            leavePersonal: 'Nghỉ việc riêng',
            leaveCompensatory: 'Nghỉ bù',
            leaveBereavement: 'Nghỉ tang',
            leaveMaternity: 'Nghỉ thai sản',
            leaveMarriage: 'Nghỉ kết hôn',
            leaveUnknown: 'Nghỉ',
            leaveFullDay: 'Cả ngày',
            leaveAM: 'Nửa ngày buổi sáng',
            leavePM: 'Nửa ngày buổi chiều',
            leaveFullDayOption: 'Cả ngày (1 ngày)',
            leaveAMOption: 'Buổi sáng (0.5 ngày)',
            leavePMOption: 'Buổi chiều (0.5 ngày)',
            leavePeriodHint: 'Nghỉ nửa ngày và nghỉ theo giờ chỉ áp dụng trong cùng một ngày; tối thiểu 1 giờ và tự động tính theo thời gian bắt đầu/kết thúc.',
            leaveDeductDays: 'Số ngày trừ lương',
            dayUnit: 'ngày',
            hourUnit: 'giờ',
            ...
            leaveHours: 'Thời gian bắt đầu/kết thúc',
            leaveHoursHint: 'Hệ thống tự tính số giờ và quy đổi 8 giờ = 1 ngày.',
            leaveReason: 'Lý do',
            ...
            overtimeDesc: 'Tăng ca cần gửi đơn trước hoặc sau; sau khi duyệt sẽ tính theo số giờ được duyệt.',
            overtimeDate: 'Ngày tăng ca',
            plannedOvertimeHours: 'Số giờ tăng ca dự kiến',
            overtimeRateHint: '💡 2 giờ đầu: lương giờ ×1.34 · 2 giờ sau: lương giờ ×1.67',
            overtimeCompensation: 'Cách bù tăng ca',
            overtimePay: 'Nhận tiền tăng ca',
            compLeave: 'Đổi nghỉ bù',
            overtimeReason: 'Lý do tăng ca',
            overtimeReasonPlaceholder: 'Ví dụ: gấp đơn hàng, họp khách hàng',
            submitOvertime: '📤 Gửi đơn tăng ca',
            overtimeHistory: 'Lịch sử tăng ca',
            noOvertimeHistory: 'Chưa có lịch sử tăng ca',
            overtimeMissingFields: 'Vui lòng nhập ngày và số giờ',
            overtimeMaxHours: 'Số giờ tăng ca không được quá 12 giờ',
            overtimeSubmitSuccess: 'Đã gửi đơn tăng ca',
            overtimeSubmitReview: 'Đã gửi đơn, chờ quản lý duyệt',
            overtimeSubmitFailed: 'Gửi đơn thất bại',
            overtimePayLabel: 'Tiền tăng ca',
            compLeaveLabel: 'Nghỉ bù',
            overtimeFinalPay: 'Tính lương',
            overtimeApprovedHours: 'Đã duyệt',
            overtimeActualHours: 'Thực tế',
