(function () {
    ...
    var DICT = {
        'zh-TW': {
            ...
            leavePeriodHint: '半天請假只能選同一天；小時請假最低 1 小時，扣薪按 8 小時 = 1 天計算。',
        ...
        'vi-VN': {
            ...
            leavePeriodHint: 'Nghỉ nửa ngày chỉ áp dụng cùng một ngày; nghỉ theo giờ tối thiểu 1 giờ, tính lương theo 8 giờ = 1 ngày.',
